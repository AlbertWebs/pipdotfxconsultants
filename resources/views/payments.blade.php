         ...
         <body>
            ...
            <div class="main" >
               ...
               <div class="content">
                  <video playsinline autoplay muted loop poster="polina.jpg" id="bgvid">
                     <source src="{{url('/')}}/uploads/banners/forex.webm" type="video/webm">
                     ...
                     <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                        <div class="pay-tabs" style="display:none;">
                           ...
                           <ul class="resp-tabs-list">
                              {{-- <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span><label class="pic3"></label>M-PESA Online</span></li> --}}
                        ...
                        ?>
                           <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                              <div class="payment-info">
                                 ...
                                 <li style="color:#002e44">Enter Till Number {{$Settings->mpesa}}</li>
                                 <li style="color:#002e44">Enter Amount  {{$InKESS}}</li>
                                 ...
                                 <form method="post" id="verify-submit">
                                    ...
                                    <div class="tab-for">
                                       ...
                                       <input type="hidden" value="{{Auth::user()->email}}" name="user_id">
                                    </div>
            ...
            <script>
               ...
               $("#verify-submit").submit(function(stay){
                     ...
                     $.ajax({
                        type: 'POST',
                        url: "{{url('/')}}/api/v1/c2b/verification",
                        data: formdata, // here $(this) refers to the ajax object not form
                        success: function (data) {
                           if(data == 'Success'){
