            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-flex uk-flex-center" data-uk-grid>
                    <div class="uk-width-1-1@m uk-text-center">
                            ...
                            <div class="uk-card-body">
                                <table class="uk-table uk-table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img class="uk-margin-small-right" src="{{asset('theme/img/in-lazy.svg')}}" data-src="{{asset('theme/img/in-profit-fxeur.svg')}}" alt="fx-flag" width="29" height="17" data-uk-img><span class="in-pairname">{{$Signal->currency_pair}}</span></td>
                                            <td>
                        ...
                        <a class="uk-text-uppercase uk-text-small" href="{{url('/')}}/all-forex-signals">All Signals</a>
                    </div>
                </div>
            </div>
        </div>
