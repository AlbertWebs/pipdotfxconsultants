...
<!--== BODY CONTNAINER ==-->
 <div class="container-fluid sb2">
                        ...
                        <form method="POST" action="{{url('/')}}/admin/edit_Topic/{{$Topic->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="title" id="list-title" value="{{$Topic->title}}" type="text" class="validate">
                            ...
                            <video oncontextmenu="return false;" width="100%" height="320" controls controlsList="nodownload"> 
                                <source src="{{url('/')}}/uploads/topics/{{$Topic->video}}" type="video/mp4"> 
                          </video> 
                            {{--  --}}
  ...
  {{-- Images --}}
                            ...
                            <input type="hidden" name="video_cheat" value="{{$Topic->video}}">
                            <div class="row">
                                <div class="input-field col s12">
