        ...
        <div class="sb2-2">
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/edit_Testimonial/{{$Testimonial->id}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                

                                <div class="input-field col s12">
                                    <input autocomplete="off" name="company" id="list-title" value="{{$Testimonial->company}}" type="text" class="validate" required>
                                    <label for="list-title">Company</label>
                                </div>

                                <div class="input-field col s12">
                                    <input autocomplete="off" name="position" value="{{$Testimonial->position}}" id="list-title" type="text" class="validate" required>
                                    <label for="list-title">Position</label>
                                </div>
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="rating" id="list-title" max="5" value="{{$Testimonial->rating}}" type="number" class="validate" required>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea required id="article-ckeditor" name="content" class="materialilze-textarea" placeholder="content">{{$Testimonial->content}}</textarea>
                                </div>
                            </div><br><br>
                           
                            <div class="row">
                                <div class="input-field col s12">
                                    <input required autocomplete="off"  id="post-auth" value="{{$Testimonial->name}}" name="name" type="text" class="validate">
                            ...
                            <div class="">
                                <div class="input-field col s12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img class="image-preview" style="width:auto;" src="{{url('/')}}/uploads/testimonials/{{$Testimonial->image}}" id='img-upload'/>
                                    </div>
                                </div>
                                </div>
                            </div>
