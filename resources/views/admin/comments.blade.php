            ...
            <div class="sb2-2-1">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$item->id}}</td>
                            <td><?php $BlogPost = \App\Models\Blog::find($item->post_id); echo $BlogPost->title; ?></td>
                            <td>
                                {{$item->comment}}
                            </td>
                            <td>
                            ...
                            <td><a href="{{url('/')}}/admin/approveComment/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-check" aria-hidden="true"></i>
                                @if($item->status == 1)
                            ...
                            function archiveFunction{{$item->id}}()
                                {
                                    ...
                                    swal({
                                        ...
                                        if (willDelete) {
                                            //do the ajax stuff.
                                            $.ajax({
                                                url: "{{url('/')}}/admin/deleteCommentAjax",
